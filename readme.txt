=== postnet-plugin ===
Contributors: postnet-plugin
Tags: PostNet, PostNet Plugin, PEP, PEP CELL, PEP HOME, ShoeCity, Tellie Town, PEPKOR, SKYNET, RAM, WooCommerce, WooCommerse, PARGO, POSTNET, POPI, POPIA, pargo, PostNet
...
A1: This plugin enables visiters to your store to select PostNet as a shipping method.
This plugin will then apply a flat rate of R59.95 to the order as shipping cost and requet a PostNet Branch where the order need to be sent to. This also assumes a delivery time of 7-9 working days which is indicated on the checkout page.
...
Q5: How will the clinets know what the code of their nearest POSTNET Branch is?
